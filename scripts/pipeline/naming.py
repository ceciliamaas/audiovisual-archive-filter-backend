...
class NamingConvention:
    ...
    @staticmethod
    def frame_local_path(
        video_name: str, frame_index: int, base_dir: str = "data/frames"
    ) -> Path:
        ...
        """
        return (
            Path(base_dir) / video_name / NamingConvention.frame_filename(frame_index)
        )
    ...
    def object_local_path(
        ...
        return (
            Path(base_dir)
            / video_name
            / NamingConvention.object_filename(frame_index, object_index)
        )
